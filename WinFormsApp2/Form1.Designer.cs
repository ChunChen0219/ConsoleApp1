namespace WinFormsApp2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// openform2
			// 
			openform2.Location = new Point(433, 262);
			openform2.Name = "openform2";
			openform2.Size = new Size(75, 23);
			openform2.TabIndex = 0;
			openform2.Text = "打開form2";
			openform2.UseCompatibleTextRendering = true;
			openform2.UseVisualStyleBackColor = true;
			// 
			// label1
			// 
			label1.AutoSize = true;
			label1.Location = new Point(602, 267);
			label1.Name = "label1";
